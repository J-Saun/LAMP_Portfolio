...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="../">Back to Projects</a>
            </li>
        </ul>
    </nav>
    <div class="container">
                    ...
                    <div class="row d-flex justify-content-center mt-5">
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div class="card py-3 px-2">
                                ...
                                <form action="signup_process.php" method="post" class="myform">
                                    <div class="form-group">
                                        <input type="text" name="users_first" class="form-control"
                                            placeholder="Enter First Name">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="users_last" class="form-control"
                                    ...
                                    <div class="col-md-6 col-12 btn"><a href="./login.php">Already have an account?
                                            Login
                                            here!</a>
                                    </div>
                                    <div class="form-group mt-3">
                                        <button type="submit" class="btn btn-block btn-primary btn-lg"><small><i
                                                    class="far fa-user pr-2"></i>Register</small></button>
                                    </div>
                            </div>
                            </form>
                        </div>
